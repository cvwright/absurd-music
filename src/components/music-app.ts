...
export class MusicApp extends LitElement {
    ...
    return html`
      ...
      <nav class="tab-bar">
        <div class="tab-bar-inner">
          <button
            class="tab-bar-item ${this.currentView === 'library' || this.currentView === 'album' || this.currentView === 'artist' || this.currentView === 'recent' ? 'active' : ''}"
            @click=${() => this.handleNavigate(new CustomEvent('navigate', { detail: { view: 'library' } }))}
          >
          ...
          <button
            class="tab-bar-item ${this.currentView === 'search' ? 'active' : ''}"
            @click=${() => this.handleNavigate(new CustomEvent('navigate', { detail: { view: 'search' } }))}
          >
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button
            class="tab-bar-item ${this.currentView === 'playlist' ? 'active' : ''}"
            @click=${this.handlePlaylistTab}
          >
            <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  private handlePlaylistTab() {
    if (this.playlists.length > 0) {
      this.currentView = 'playlist';
      this.viewParams = { id: this.playlists[0].playlist_id };
    } else {
